  ...
  try {
    ...
    const users = await User.insertMany([
      ...
      },
      {
        ...
        password: await hashedPassword("Pranav123"),
        phone: "9824500001",
        city: "Ahemdabad",
        role: "AGENT",
        isActive: true,
      ...
      },
      {
        ...
        password: await hashedPassword("Hiten123"),
        phone: "9824500002",
        city: "Junagadh",
        role: "AGENT",
        isActive: true,
      ...
      {
        name: "Sagar Ranatanpara",
        email: "sagar123@gmail.com",
        password: await hashedPassword("Sagar123"),
        phone: "9824500004",
        city: "Ahemdabad",
        role: "USER",
        isActive: true,
    ...
    const properties = await Property.insertMany([
      {
        title: "Skyline Towers: 3 BHK Flat Apparments",
        description:
      ...
      },
      {
        ...
        propertyType: "Plot",
        status: "Sale",
        images: ["plot1.1.jpg", "plot1.1.jpeg"],
        ownerId: users[2]._id,
